...
class CmcTicker(BaseModel):
    ...
    base_id: str = "1"
    quote_id: str = "1521"
    last_price: float = 7777777.777
    base_volume: float = 7777777.777
    quote_volume: float = 7777777.777
    isFrozen: str = "0"
...
class CmcOrderbook(BaseModel):
    ...
    book (arranged by best asks/bids) with full depth returned for a given market pair.
    '''
